...
fun <T> ListItemPicker(
    ...
    val extraFollowingNumbersPadding = 48.dp
    ...
    Layout(
        ...
        content = {
            ...
            Box(
                modifier = Modifier
                    .padding(vertical = verticalMargin + 10.dp, horizontal = 20.dp)
                    ...
                    if (indexOfElement > 0)
                        Label(
                            ...
                            modifier = baseLabelModifier
                                .offset(y = -halfNumbersColumnHeight - extraFollowingNumbersPadding)
